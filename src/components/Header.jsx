        ...
        >
            <div className="container mx-auto px-6 flex justify-between items-center text-white">
                ...
                <nav className="hidden md:flex items-center gap-8 font-sans text-sm tracking-wide uppercase backdrop-blur-sm bg-white/10 px-8 py-3 rounded-full border border-white/20">
                    <a href={`${import.meta.env.BASE_URL}`} className="hover:text-secondary transition-colors">Inicio</a>
                    <a href={`${import.meta.env.BASE_URL}about`} className="hover:text-secondary transition-colors">Nosotros</a>
                    <a href="#" className="hover:text-secondary transition-colors">Servicios</a>
                    <a href={`${import.meta.env.BASE_URL}blog`} className="hover:text-secondary transition-colors">Blog</a>
                    <a href={`${import.meta.env.BASE_URL}contact`} className="hover:text-secondary transition-colors">Contacto</a>
                </nav>
