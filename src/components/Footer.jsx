        ...
        <footer className="bg-[#051111] text-white py-16 border-t border-white/5">
            <div className="max-w-7xl mx-auto px-4 text-center">
                ...
                <nav className="flex justify-center flex-wrap gap-8 md:gap-12 mb-10 font-sans text-sm tracking-widest uppercase text-gray-400">
                    ...
                    <a href={`${import.meta.env.BASE_URL}galeria`} className="hover:text-secondary transition-colors duration-300">Galería</a>
                    <a href={`${import.meta.env.BASE_URL}eventos`} className="hover:text-secondary transition-colors duration-300">Eventos</a>
