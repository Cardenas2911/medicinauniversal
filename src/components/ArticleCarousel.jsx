...
const ArticleCard = ({ title, date, image, slug, author = "Medicina Universal" }) => (
    <a href={`/blog/${slug}`} className="block group relative h-[400px] w-[300px] md:w-[350px] flex-shrink-0 rounded-3xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300">
        {/* Background Image */}
        <img
            src={image}
            alt={title}
        ...
        <section className="py-24 px-4 md:px-10 bg-[#0e2a29]">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-12 flex justify-between items-end">
                    ...
                    <a href="/blog" className="hidden md:flex items-center gap-2 text-white hover:text-secondary transition-colors group">
                ...
                >
                    ...
                    <a href="/blog" className="snap-center w-[300px] md:w-[350px] h-[400px] flex-shrink-0 rounded-3xl border-2 border-white/10 flex flex-col items-center justify-center gap-4 group hover:border-secondary/50 transition-colors">
                ...
                <div className="mt-8 text-center md:hidden">
                    <a href="/blog" className="inline-flex items-center gap-2 text-secondary font-bold uppercase tracking-wide text-sm">
                        Ir al Blog
